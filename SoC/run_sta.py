...
def run_dc_shell_with_tcl(tcl_script):
    # dc_shell command
    dc_shell_command = "pt_shell -x \"source {}; quit;\"".format(tcl_script)
    try:
        # start
        ...
        if process.returncode != 0:
            print("pt_shell Fail:", process.returncode)
        else:
            print("pt_shell Success!")
    except OSError as e:
        print("OSError:", e)
...
read_ddc ./../syn/outputs/${{TOPDESIGN}}_{0}_{1}_unmapped.ddc
